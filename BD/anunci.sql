...
(26, 'Me han robado la bici de mi hijo', '2016-10-05', '2016-10-05', 'Ciutat Vella', 'Han roto la puerta del bicing y se han llevado mi bici.', 'CONOR', 'RAY 14', 'NEGRO / ROJO', NULL, 'El pedal derecho esta roto por la mitad.', '000013', '', NULL),
(27, 'PÉRDIDA DE LA BICI DE MI HIJO', '2016-09-05', '2016-10-06', 'Sants-Montjuic', 'La tenia en el parking y ya no está.', 'CONOR', 'METEOR 16 ', 'NEGRO / VERDE', NULL, '', '000014', '', NULL),
(28, 'ME HAN ROBADO LA BICI', '2016-06-07', '2016-06-08', 'Les Corts', 'La tenia en el taller y me han entrado a robar en el taller.', 'CONOR', 'WRC INVADER', 'ROJO', NULL, '', '000015', '', NULL),
(29, 'URGENTE! Me han robado la bici', '2016-02-03', '2016-02-06', 'Horta-Guinardó', 'La tenia guardada en la peluqueria y me han robado en la peluqueria.', 'CONOR ', '540', 'BLANCO / ROSA', NULL, 'Porfavor contactar conmigo.', '000016', '', NULL),
(30, 'MI BICI (PLEGABLE)', '2016-10-05', '2016-10-05', 'San Andrés', 'Me han robado la bici a lado del metro.', 'DAHON', 'SUV', 'GRIS / BLANCA', NULL, 'Necesito recuperar mi bicicleta porfavor, ayudarme.', '000017', '', NULL),
(31, 'He perdido mi bici', '2016-10-02', '2016-10-04', 'San Martín', 'Me la han robado en el parking.', 'DAHON', 'VYBE', 'BLANCA', NULL, '', '000018', '', NULL),
(32, 'NO ENCUENTRO MI BICI PLEGABLE', '2016-10-07', '2016-10-07', 'Gracia', 'Me la han robado a la fuerza.', 'DAHON', 'VYBE', 'NEGRA', NULL, 'Es una bici plegable y el manillar esta desgastado.', '000019', '', NULL),
(33, 'URGENTE!!!', '2016-08-16', '2016-08-17', 'Sarriá-San Gervasio', 'He ido a buscar la bici al almacen y mi sorpresa que ya no estaba.', 'GIANT', 'FLOURISH FS 2', 'AZUL', NULL, '', '000020', '', NULL),
(34, 'URGENTE! NO ENCUENTRO MI BICI', '2016-02-09', '2016-02-09', 'Les Corts', 'La deje en la puerta de la panederia y al volver ya no estaba.', 'GIANT', 'TALON 4', 'AZUL', NULL, '', '000021', '', NULL),
(35, 'He perdido la bici ', '2016-07-05', '2016-07-05', 'Sants-Montjuic', 'Me la han robado a la fuerza.', 'GIANT', 'FLOURISH 2', 'CREMA', NULL, '', '000022', '', NULL),
(36, 'URGENTE!! Me han robado las bici de mi mujer', '2016-09-07', '2016-09-07', 'Ensanche', 'Se despitó de la bici y se la llevaron.', 'GIANT', 'TCR ADVANCED 3', 'NEGRA', NULL, 'Tiene una linia amarilla en la parte delante y en las ruedas tiene una tira blanca en toda la rueda.', '000023', '', NULL),
(37, 'URGENTE!!', '2016-09-14', '2016-09-14', 'Ciutat Vella', 'Me han robado mi de carretera', 'GIANT', 'TCR ADVANCED 2', 'ROJO', NULL, 'En las letras GIANT tiene un fondo de color rojo y las ruedas tiene una linia en toda la rueda.', '000024', '', NULL),
(38, 'me han robado la bici', '2016-10-12', '2016-10-13', 'Les Corts', 'Me han roto la puerta del parking y se han llevado la bici.', 'LIV ', 'TEMPT 4', 'NEGRA', NULL, 'PORFAVOR AYUDARME.', '000025', '', NULL),
(39, 'He perdido la bicicleta', '2016-10-11', '2016-10-11', 'Sarriá-San Gervasio', 'Me han robado la bici a la fuerza', 'LIV', 'TEMPT 2', 'BLANCA', NULL, 'ESPERO ENCONTRARLA PRONTO, AYUDARME PORFAVOR.', '000026', '', NULL),
(40, 'Le han robad la bici a mi hija', '2016-09-12', '2016-09-12', 'Gracia', 'Le han robado la bici a la fuerza, 2 chicos.', 'LIV', 'INTRIGUE 2', 'NEGRA / AZUL', NULL, 'PORFAVOR AYUDARME A ENCONTRARLA.', '000027', '', NULL),
(41, 'URGENTE!!!', '2016-10-10', '2016-10-10', 'Horta-Guinardó', 'La tenia en el garaje y han entrado a robar la bici.', 'QUIPPLAN', 'F02 CITY B', 'NEGRA', NULL, 'Si la encontrais contactar porfavor.', '000028', '', NULL),
(42, 'Me han robado la bici electrica', '2016-09-08', '2016-09-08', 'Nou Barris', 'La he dejado aparcada en el bicibox y ahora ya no esta.', 'QUIPPLAN', 'F02 CITY W', 'NEGRA', NULL, '', '000029', '', NULL),
(43, 'HE PERDIDO LA BICI', '2016-10-14', '2016-10-15', 'San Andrés', 'Se la deje a un amigo y se la robaron.', 'QUIPPLAN', 'F08 PLUS CITY B', 'NEGRA', NULL, '', '000030', '', NULL);
