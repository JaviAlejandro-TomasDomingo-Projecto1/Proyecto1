...
<div id="carrito_container"  style="display:none;">
	...
	<div id="container">
	    ...
	    <div class="clear"><!-- CLEAR --></div>
    <!--Start FORM -->
		<p style="color: black; float: right;padding-top: 10px;font-size: 13px;font-weight: 600;" >Has encontrado una bici?<br/>Crea tu anuncio <a style="color:blue;" href="page_form_create.html">Aquí</a></p>
		...
		<form name="f1" action="161010_exercici1.php" method="GET" onsubmit="return validar();">
			...
			<div><input type="date" name="fecha" step="1" min="2015-01-01" max="2020-12-31" value="<?php echo date('Y-m-d');?>" /></div><br/>
			<p>Ubicación:</p><br/>
			...
			<p>Marca:</p><br/>
			<input type="text" name="marca" id="marca" size="20" maxlength="15" /><br/><br/>
			<p>Modelo:</p><br/>
			<input type="text" name="modelo" id="modelo" size="20" maxlength="25" /><br/><br/>
			<p>Color:</p><br/>
			...
			<p>Nº serie:</p><br/>
			<input type="text" name="numero" id="numero" size="6" maxlength="6" /><br/><br/>
		...
		<br/>
		<br/>
		<p style="color: black; text-align:center;padding-top: 10px;font-size: 13px;font-weight: 200;"> Has encontrado una bici? Crea tu anuncio <a style="color:blue;" href="page_form_create.html">Aquí</a></p>
		<!--FINISH FORM -->
    <div class="clear"><!-- CLEAR --></div>
